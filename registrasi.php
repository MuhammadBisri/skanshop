  ...
  <h2 class="text-center">Registrasi</h2>
        <div class="">
            <form id="input-registrasi" method="post" action="">
                ...
                <input type="password" name="tpassword" value="<?=@$vpassword?>" class="form-control" placeholder="Input Password anda disini" required>
                <label>Confirm Password</label>
                <input type="password" name="tcpassword" value="<?=@$vpassword?>" class="form-control" placeholder="Input Password anda disini" required>
